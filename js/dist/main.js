...
exports.getFileSize = exports.readChunks = exports.getFileTotalChunk = exports.getFileMD5 = undefined;

var _Constants = __webpack_require__(4);

var _sparkMd = __webpack_require__(20);
...
var INIT_FILE_LIST_MAX_LEN = exports.INIT_FILE_LIST_MAX_LEN = 100;
...
var _FileNode = __webpack_require__(22);

var _FileNode2 = _interopRequireDefault(_FileNode);

var _FolderNode = __webpack_require__(35);
...
var Node = function Node(_ref) {
  var nodes = _ref.nodes,
      level = _ref.level;
  return nodes.valueSeq().map(function (node, key) {
    return node.get('type') === 'file' ? _react2.default.createElement(_FileNode2.default, { node: node, key: level + '-' + key }) : _react2.default.createElement(_FolderNode2.default, { node: node, level: level, key: level + '-' + key });
  }).toArray();
};
...
var _FolderOpen = __webpack_require__(24);
...
var _PDF = __webpack_require__(26);

var _PDF2 = _interopRequireDefault(_PDF);

var _PPT = __webpack_require__(27);
...
var _Excel = __webpack_require__(31);
...
exports.getUploadFileInfo = exports.createFolderStructure = exports.updateFile = exports.getFile = exports.deleteFile = exports.addFile = exports.calculateFolderTotalFile = exports.calculateFolderTotalChunk = exports.createFolder = exports.createFile = undefined;
 ...
 * @param {File} file 
 */
var createFile = exports.createFile = function createFile(file) {
    return (0, _immutable.Map)({
        filename: file.name,
        type: 'file',
        file: file,
        md5: (0, _Files.getFileMD5)(file),
        totalChunk: (0, _Files.getFileTotalChunk)(file),
        fileId: null,
        uploadedChunks: 0,
        skipChunks: [],
 ...
 */
var calculateFolderTotalChunk = exports.calculateFolderTotalChunk = function calculateFolderTotalChunk(folder) {
    var children = folder.get('children').valueSeq();
    var totalChunk = 0;
 ...
 * @param {Map} folder 
 */
var calculateFolderTotalFile = exports.calculateFolderTotalFile = function calculateFolderTotalFile(folder) {
    var children = folder.get('children').valueSeq();
    var totalFile = 0;
    for (var i = 0; i < children.size; i++) {
        var child = children.get(i);
...
var toImmutablePath = function toImmutablePath(path) {
    var pathList = path.split('/');
    var nodeName = pathList.shift();
    var immutablePath = (0, _immutable.List)();
 ...
 * @param {Map} file
 */
var addFile = exports.addFile = function addFile(root, path, file) {
    path = path == '' ? file.get('filename') : path;
    var setPath = toImmutablePath(path);
    var folderPath = setPath.pop().pop();
    var existFolder = root.getIn(folderPath.toArray());
    var newFolder = null;
 ...
 */
var deleteFile = exports.deleteFile = function deleteFile(root, path) {
    var setPath = toImmutablePath(path);
 ...
 */
var getFile = exports.getFile = function getFile(root, path) {
    var getPath = toImmutablePath(path);
 ...
 * @param {object} value 
 */
var updateFile = exports.updateFile = function updateFile(root, path, value) {
    var filePath = toImmutablePath(path);
    var file = root.getIn(filePath.toArray());
 ...
 * @param {[File]} files 
 */
var createFolderStructure = exports.createFolderStructure = function createFolderStructure(files) {
    return new Promise(function (resolve, reject) {
 ...
 */
var getUploadFileInfo = exports.getUploadFileInfo = function getUploadFileInfo(files, root) {
    var result = [];
    var offset = 0;
    while (offset < files.length) {
        var list = [];
        for (var i = offset; i < offset + _Constants.INIT_FILE_LIST_MAX_LEN && i < files.length; i++) {
            var file = files[i];
            var path = file.webkitRelativePath == '' ? file.name : file.webkitRelativePath;
            var info = getFile(root, path).delete('file').delete('status').delete('skipChunks').delete('fileId').toJS();
            list.push(info);
        }
        result.push(list);
        offset += _Constants.INIT_FILE_LIST_MAX_LEN;
    }
    return result;
};
...
var FolderPath = function (_Component) {
    _inherits(FolderPath, _Component);
    ...
    function FolderPath() {
        ...
        _classCallCheck(this, FolderPath);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FolderPath.__proto__ || Object.getPrototypeOf(FolderPath)).call.apply(_ref, [this].concat(args))), _this), _this.render = function () {
            return _react2.default.createElement(
                'div',
                { className: 'flex-container', style: { paddingRight: '16px' } },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'a',
                            null,
                            _react2.default.createElement('img', { className: 'svg', src: '/core/img/places/home.svg', alt: 'Home' })
                        )
                    ),
                    splitPath(_this.props.path).map(function (p, index) {
                        return _react2.default.createElement(
                            'div',
                            { className: 'crumb svg', key: index },
                            _react2.default.createElement(
                                'a',
                                null,
                                p
...
var _UploadButton = __webpack_require__(19);
...
var _FolderPath = __webpack_require__(9);

var _FolderPath2 = _interopRequireDefault(_FolderPath);

var _Modal = __webpack_require__(37);

var _Modal2 = _interopRequireDefault(_Modal);

var _UploadPathSelector = __webpack_require__(38);

var _UploadPathSelector2 = _interopRequireDefault(_UploadPathSelector);

var _Util = __webpack_require__(58);

var _FileUI = __webpack_require__(7);
...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.sendUploadFileRequest = function () {
            var infoList = (0, _FileUI.getUploadFileInfo)(_this.state.files, _this.state.dumpRoot);
            console.log(infoList);
            console.log((0, _Util.memorySizeOf)(infoList));
            var url = _this.baseUrl + '/files';
            (0, _API.sendFileInitRequest)(url, _this.state.uploadingRootPath, infoList, function (_ref) {
                var data = _ref.data,
                    next = _ref.next;

                var root = _this.state.dumpRoot;
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (file.uploadedChunks != null && file.uploadedChunks != undefined) {
                        var skipChunks = file.uploadedChunks.map(function (chunk) {
                            return chunk.chunkMd5;
                        });
                        updateValue = Object.assign(updateValue, { skipChunks: skipChunks });
                    }
                    root = (0, _FileUI.updateFile)(root, file.relativePath, updateValue);
                }
                _this.setState({
                    dumpRoot: root
                });
                ...
                return (0, _API.sendFolderChunks)(_this.baseUrl, _this.state.dumpRoot,
                ...
                function (_ref2) {
                    var data = _ref2.data,
                        ...
                        chunkIndex = _ref2.chunkIndex;

                    console.log('do next chunk');
                    var newRoot = _this.state.dumpRoot;
                    console.log('chunkIndex=' + chunkIndex);
                    var relativePath = node.get('relativePath');
                    var path = relativePath == '' ? node.get('filename') : relativePath;
                    newRoot = (0, _FileUI.updateFile)(newRoot, path, {
                        uploadedChunks: chunkIndex,
                        uploaded: finished
                    });
                    _this.setState({
                        dumpRoot: newRoot,
                        uploadedChunks: _this.state.uploadedChunks + 1
                    });
                },
                ...
                function (_ref3) {
                    ...
                    if (isFile == true) {
                        var newRoot = _this.state.dumpRoot;
                        var relativePath = node.get('relativePath');
                        var updatePath = relativePath == '' ? node.get('filename') : relativePath;
                        newRoot = (0, _FileUI.updateFile)(newRoot, updatePath, {
                            uploaded: true,
                            merged: true
                        });
                        var uploadedChunks = _this.state.uploadedChunks;
                        if (skiped) {
        ...
        _this.onFiles = function (files) {
            ...
            var dumpRoot = (0, _FileUI.createFolderStructure)(files);
            var totalChunks = (0, _FileUI.calculateFolderTotalChunk)(dumpRoot);
            _this.setState({
                loadingText: '加载中',
                loading: false,
        ...
        _this.onUploadPathChange = function (newPath) {
            _this.setState({
        ...
        _this.onUploadPathModalClose = function () {
            _this.setState({
                showModal: false
            });
        };

        _this.openUploadPathSelector = function () {
            _this.setState({
                showModal: true
            });
        };

        _this.getUploadingPercentage = function (current, total) {
            if (total == 0) {
                return 0;
            } else {
        ...
        _this.render = function () {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'button', onClick: _this.onSubmitClick, disabled: _this.state.files == 0 },
                        '\u53D1\u9001\u8BF7\u6C42'
                    ),
                    _react2.default.createElement(
                        'span',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _this.getUploadingPercentage(_this.state.uploadedChunks, _this.state.totalChunks),
                            '%'
                        ),
                        _react2.default.createElement('progress', { value: _this.getUploadingPercentage(_this.state.uploadedChunks, _this.state.totalChunks), max: '100' })
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'app-row flex-container' },
                    _react2.default.createElement(_FolderPath2.default, { path: _this.state.uploadingRootPath }),
                    _react2.default.createElement(
                        'button',
                        { className: 'button', onClick: _this.openUploadPathSelector },
                        _react2.default.createElement('span', { className: 'icon icon-rename' }),
                        '\u7F16\u8F91'
                    )
                ),
                _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_UploadPathSelector2.default, {
                        baseUrl: _this.baseUrl,
                        path: _this.state.uploadingRootPath,
                        onSelected: _this.onUploadPathChange,
                        onRequestClose: _this.onUploadPathModalClose })
                ),
                _react2.default.createElement(_Loading2.default, { text: _this.state.loadingText, show: _this.state.loading })
            );
        };

        _this.state = {
            dumpRoot: (0, _FileUI.createFolder)('root'),
            loading: false,
            loadingText: '加载中',
            files: [],
            totalChunks: 0,
        ...
        _this.baseUrl = OC.generateUrl('/apps/uploaderdash');
        return _this;
    }
...
var UploadButton = function (_Component) {
    ...
    function UploadButton(props) {
        ...
        _this.handleOutsideClick = function (e) {
            ...
            if (_this.domRef.contains(e.target)) {
                return;
            }
            _this.closeMenu();
        };
        ...
        _this.render = function () {
            return _react2.default.createElement(
                'div',
                { style: { display: 'inline-block' }, ref: function ref(e) {
                        _this.domRef = e;
                    } },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'popovermenu menu menu-left ' + (_this.state.menuOpen ? 'open' : ''), style: { left: '48px' } },
                        _react2.default.createElement(
                            'ul',
                            null,
                            _react2.default.createElement(
...
var Tree = function Tree(_ref) {
  ...
  return _react2.default.createElement(
    'ul',
    { className: 'tree' },
    _react2.default.createElement(_Node2.default, { nodes: root.get('children'), level: 0 })
  );
};
...
var FileStatusIcon = function FileStatusIcon(_ref) {
    ...
    var merging = node.get('inited') && node.get('uploaded') && !node.get('merged');
    var finish = node.get('inited') && node.get('uploaded') && node.get('merged');
    return _react2.default.createElement(
        'div',
...
var FileIcon = function FileIcon(_ref2) {
    ...
    var Icon = (0, _Icons.getFileIcon)(node.get('file'));
    return _react2.default.createElement(
        'div',
...
var FileSize = function FileSize(_ref3) {
    ...
    return _react2.default.createElement(
        ...
        (0, _Files.getFileSize)(node.get('file'))
    );
};
...
var getUploadedPercentage = function getUploadedPercentage(node) {
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    getUploadedPercentage(node),
                    '%'
                ),
                _react2.default.createElement('progress', { hidden: !showProcess(node), value: getUploadedPercentage(node), max: '100' })
            )
        )
    );
};
...
var FolderNode = function (_Component) {
    ...
    function FolderNode(props) {
        ...
        _this.render = function () {
            return _react2.default.createElement(
                'li',
                { className: '' + (_this.props.level == 0 ? 'no-left-padding' : '') },
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'tree-file-name' },
                        _this.props.node.get('filename')
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'tree-file-status' },
                        (0, _FileUI.calculateFolderTotalFile)(_this.props.node),
                        ' \u4E2A\u6587\u4EF6'
                    )
                ),
                _this.state.collapsed ? '' : _react2.default.createElement(
                    'ul',
                    null,
                    _react2.default.createElement(_Node2.default, { nodes: _this.props.node.get('children'), level: _this.props.level + 1 })
                )
            );
        };
    ...
    function Modal(props) {
        ...
        _this.render = function () {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'modal', style: { display: '' + (_this.props.show ? 'block' : 'none') } },
...
var UploadPathSelector = function (_Component) {
    _inherits(UploadPathSelector, _Component);

    function UploadPathSelector(props) {
        _classCallCheck(this, UploadPathSelector);

        var _this = _possibleConstructorReturn(this, (UploadPathSelector.__proto__ || Object.getPrototypeOf(UploadPathSelector)).call(this, props));

        _this.componentDidMount = function () {
            _this.fetchFolderList(_this.state.path);
        };

        _this.fetchFolderList = function (path) {
            _axios2.default.get(_this.props.baseUrl + '/subdirs?path=' + path).then(function (resp) {
                _this.setState({
                    folders: resp.data
                });
            });
        ...
        _this.enterFolder = function (folder) {
            var newPath = (_this.state.path == '/' ? '' : _this.state.path) + '/' + folder;
            _this.setState({
                path: newPath,
                selectedFolder: -1
            });
            _this.fetchFolderList(newPath);
        };

        _this.backParentFolder = function () {
            var newPath = _this.state.path;
            if (newPath != '/') {
                var list = newPath.split('/');
                list.pop();
                newPath = list.join('/');
            }
            _this.setState({
        ...
        _this.selectFolder = function (index) {
            _this.setState({
        ...
        _this.onSeleted = function () {
            var selectedFolder = '' + (_this.state.selectedFolder == -1 ? '' : _this.state.folders[_this.state.selectedFolder]);
            var selectedPath = (_this.state.path == '/' ? '' : _this.state.path) + '/' + selectedFolder;
            _this.props.onSelected(selectedPath);
        };
        ...
        _this.render = function () {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'app-row flex-container modal-header' },
                    _react2.default.createElement(
                        'span',
                        { className: 'button', onClick: _this.backParentFolder },
                        '\u8FD4\u56DE'
                    ),
                    _react2.default.createElement(_FolderPath2.default, { path: _this.state.path })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'modal-body' },
                    _this.state.folders.length == 0 ? _react2.default.createElement(
                        'div',
                        { className: 'app-row flex-container' },
                        '\u65E0\u5B50\u76EE\u5F55'
                    ) : '',
                    _this.state.folders.map(function (folder, index) {
                        return _react2.default.createElement(
                            'div',
                            { className: 'app-row flex-container',
                                key: index,
                                onClick: function onClick() {
                                    return _this.selectFolder(index);
                                },
                                onDoubleClick: function onDoubleClick() {
                                    return _this.enterFolder(folder);
                                },
                                style: _this.state.selectedFolder == index ? { backgroundColor: "#BDBDBD" } : {} },
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'app-row flex-container-end modal-footer' },
                    _react2.default.createElement(
                        'button',
                        { className: 'button', onClick: _this.onCancel },
                        '\u53D6\u6D88'
                    ),
                    _react2.default.createElement(
                        'button',
                        { className: 'button', onClick: _this.onSeleted },
                        '\u9009\u62E9'
                    )
                )
            );
    ...
    return UploadPathSelector;
}(_react.Component);

exports.default = UploadPathSelector;
...
var memorySizeOf = exports.memorySizeOf = function memorySizeOf(obj) {
    var bytes = 0;
...
exports.sendFolderChunks = exports.sendFileInitRequest = undefined;
 ...
 * @return {Promise}
 */
var sendFileInitRequest = exports.sendFileInitRequest = function sendFileInitRequest(url, rootPath, list, handler) {
    var index = 0;
    var next = function next() {
        if (index < list.length) {
            return _axios2.default.post(url, { files: list[index], rootPath: rootPath }).then(function (resp) {
                index++;
                return { data: resp.data, next: next };
            }).then(handler);
        } else {
 ...
 * @return {Promise}
 */
var sendFileChunks = function sendFileChunks(url, node, chunkHandler) {
    if (node.get('merged')) {
        return Promise.resolve({ merged: true });
    }
    return (0, _Files.readChunks)(node.get('file'), function (_ref, allChunkLoaded) {
        var data = _ref.data,
            index = _ref.index,
            md5 = _ref.md5;
        ...
        if (node.get('skipChunks').includes(md5)) {
            ...
            promise = Promise.resolve({ skiped: true, node: node, finished: allChunkLoaded, chunkIndex: index });
        } else {
            ...
            promise = _axios2.default.post(url + '/chunks', form, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            }).then(function (resp) {
                return { data: resp.data, node: node, skiped: false, finished: allChunkLoaded, chunkIndex: index };
            });
        }
 ...
 */
var sendFolderChunks = exports.sendFolderChunks = function sendFolderChunks(baseUrl, folder, chunkHandler, fileHandler) {
    var nodes = folder.get('children').valueSeq();
    var index = 0;
     ...
     * @return {Promise}
     */
    var nextFile = function nextFile(file) {
        return sendFileChunks(baseUrl, file, chunkHandler).then(function (_ref2) {
            var merged = _ref2.merged;

            if (!merged) {
                return _axios2.default.post(baseUrl + '/merge', { fileId: file.get('fileId') }).then(function (resp) {
                    return { data: resp.data, skiped: false };
                });
            } else {
            ...
            return { data: data, node: file, next: next, isFile: true, skiped: skiped };
        }).then(fileHandler);
    };
    /**
     ...
     * @return {Promise}
     */
    var nextFolder = function nextFolder(folder) {
        return sendFolderChunks(baseUrl, folder, chunkHandler, fileHandler).then(function () {
            return { data: null, node: folder, next: next, isFile: false };
        }).then(fileHandler);
    };
